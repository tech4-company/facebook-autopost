...
## 5. Utworzenie osobnego publicznego repo

```bash
cd /Users/adamrojek/Desktop/projects/tech4good/oss/facebook-autopost-supabase
git init
git checkout -b main
git add .
git commit -m "Initial open-source Facebook autopost module"
